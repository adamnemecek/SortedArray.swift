...
//    
//    init<S : Sequence>(a: S, b: S, cmp: @escaping Relation<Element>) where S.Iterator.Element == Element
//}
//
...
//}
//
//public typealias Relation<Element: Comparable> = (Element, Element) -> Bool
//
